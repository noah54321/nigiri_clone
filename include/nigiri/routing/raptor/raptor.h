...
struct raptor {
  ...
  void add_start(location_idx_t const l, unixtime_t const t) {
    ...
    best_[to_idx(l)][v] =
        get_best(unix_to_delta(base(), t), best_[to_idx(l)][v]) - max_safety_time;
    round_times_[0U][to_idx(l)][v] =
        get_best(unix_to_delta(base(), t), round_times_[0U][to_idx(l)][v]) - max_safety_time;
